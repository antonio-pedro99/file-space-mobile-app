    ...
    return MultiRepositoryProvider(
      providers: [
        RepositoryProvider<AuthRepository>(
            create: (_) => AuthRepository(FirebaseAuthService())),
        RepositoryProvider<GoogleDriveStorageRepository>(
            create: (_) => GoogleDriveStorageRepository(GoogleDriveService()))
      ],
      child: Builder(
        builder: (context) {
              ...
              providers: [
                ...
                BlocProvider<StorageBloc>(
                    create: (_) => StorageBloc(
                        driveRepository:
                            RepositoryProvider.of<GoogleDriveStorageRepository>(
                                context))),
